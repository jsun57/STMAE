...
class DCRNN(nn.Module, Seq2SeqAttrs):
    ...
    def feature_masking(self, x, mask_ratio, mask_f_strategy='patch_uniform', mask=None, *args, **kwargs):
        ...
        patch_length = kwargs.get('patch_length', 1)
    ...
    def forward(self, x, batches_seen=0, mask_s=0, mask_f=0, mask_s_strategy='rw_fill', mask_f_strategy='patch_uniform', *args, **kwargs):
        """
